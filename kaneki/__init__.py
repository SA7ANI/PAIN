...
from kaneki.config import get_str_key, get_int_key, get_list_key, get_bool_key
from kaneki.utils.logger import log
from kaneki.versions import KANEKI_VERSION

log.info("----------------------")
log.info("|     KEN KANEKI     |")
log.info("----------------------")
log.info("Version: " + KANEKI_VERSION)

if get_bool_key("DEBUG_MODE") is True:
    KANEKI_VERSION += "-debug"
