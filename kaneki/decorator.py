...
from kaneki import BOT_USERNAME, dp
from kaneki.config import get_bool_key
from kaneki.modules.error import parse_update
from kaneki.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("kaneki.utils.filters." + module_name)
