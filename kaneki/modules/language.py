...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(InlineKeyboardButton(
        strings['crowdin_btn'], url='https://crowdin.com/project/kenkaneki'))
    if edit:
        markup.add(InlineKeyboardButton(
...
__help__ = """
This module is dedicated towards utlising Kaneki's localization feature! You can also <a href='https://crowdin.com/project/kenkaneki'>contribute</a> for improving localization in Kaneki!
...
Kaneki will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
