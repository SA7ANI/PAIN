...
#
# This file is part of Kaneki (Telegram Bot)
#
...
from kaneki import dp
from kaneki.decorator import register
from kaneki.modules.utils.connections import chat_connection
from kaneki.modules.utils.language import get_strings_dec, get_strings
from kaneki.modules.utils.message import convert_time, get_args, need_args_dec, InvalidTimeUnit
from kaneki.modules.utils.restrictions import ban_user, kick_user, mute_user
from kaneki.modules.utils.user_details import is_user_admin, get_user_link
from kaneki.services.mongo import db
from kaneki.services.redis import bredis, redis
from kaneki.utils.cached import cached
from kaneki.utils.logger import log
...
Kaneki: <code>Please send expiration time [...]</code>
