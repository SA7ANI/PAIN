...
from kaneki import OWNER_ID, OPERATORS, KANEKI_VERSION, bot, dp
from kaneki.decorator import REGISTRED_COMMANDS, COMMANDS_ALIASES, register
from kaneki.modules import LOADED_MODULES
from kaneki.services.mongo import db, mongodb
from kaneki.services.redis import redis
from kaneki.services.telethon import tbot
from kaneki.config import get_str_key
from kaneki.utils.channel_logs import channel_log
...
async def restart_bot(message):
    m = await message.reply("Kaneki will be restarted...")
    args = [sys.executable, "-m", "kaneki"]
...
async def stats(message):
    text = f"<b>Kaneki {KANEKI_VERSION} stats</b>\n"
