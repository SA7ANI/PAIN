...
from kaneki import OWNER_ID, BOT_ID, OPERATORS, decorator, bot
...
In both cases Kaneki will help you.
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means Kaneki will wait file message from you. Type /cancel to leave from it.
