...
from kaneki import bot_info
from kaneki.decorator import register
from kaneki.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(InlineKeyboardButton(strings['btn_channel'], url='https://t.me/KanekiNews'),
                InlineKeyboardButton(strings['btn_source'], url='https://github.com/SA7ANI/KenKaneki'))
