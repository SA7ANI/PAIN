...
from pain import dp, TOKEN, bot
from pain.config import get_bool_key, get_list_key
from pain.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key('LOAD_MODULES'):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("pain.modules." + module_name)
...
import_module('pain.modules.pm_menu')
# Import misc stuff
import_module("pain.utils.exit_gracefully")
if not get_bool_key('DEBUG_MODE'):
    import_module("pain.utils.sentry")
...
import_module("pain.utils.db_structure_migrator")
...
if use_uvloop is True:
    log.info("PAIN: Using uvloop to speedup.")
    uvloop.install()
