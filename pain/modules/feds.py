...
from pain import OWNER_ID, BOT_ID, OPERATORS, decorator, bot
...
In both cases PAIN will help you.
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means PAIN will wait file message from you. Type /cancel to leave from it.
