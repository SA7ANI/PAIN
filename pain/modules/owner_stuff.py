...
from pain import OWNER_ID, OPERATORS, PAIN_VERSION, bot, dp
from pain.decorator import REGISTRED_COMMANDS, COMMANDS_ALIASES, register
from pain.modules import LOADED_MODULES
from pain.services.mongo import db, mongodb
from pain.services.redis import redis
from pain.services.telethon import tbot
from pain.config import get_str_key
from pain.utils.channel_logs import channel_log
...
async def restart_bot(message):
    m = await message.reply("PAIN will be restarted...")
    args = [sys.executable, "-m", "pain"]
...
async def stats(message):
    text = f"<b>PAIN {PAIN_VERSION} stats</b>\n"
