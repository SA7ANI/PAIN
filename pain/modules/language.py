...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(InlineKeyboardButton(
        strings['crowdin_btn'], url='https://crowdin.com/project/pain'))
    if edit:
        markup.add(InlineKeyboardButton(
...
__help__ = """
This module is dedicated towards utlising PAIN's localization feature! You can also <a href='https://crowdin.com/project/PAIN'>contribute</a> for improving localization in PAIN!
...
PAIN will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
