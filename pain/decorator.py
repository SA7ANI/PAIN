...
from pain import BOT_USERNAME, dp
from pain.config import get_bool_key
from pain.modules.error import parse_update
from pain.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("pain.utils.filters." + module_name)
